namespace AuthService
{
    ...
    public static class CustomAuthorizerHelper
    {
        ...
        /// <param name="accoundId"> The 12-digit AWS account Id of the REST API owner </param>
        ...
        public static string ComposeResource(string region, string accoundId, string apiId, string stage, string httpVerb, string resourcePath)
        {
            return $"arn:aws:execute-api:{region}:{accoundId}:{apiId}/{stage}/{httpVerb}/{resourcePath}";
        }
    }
}
